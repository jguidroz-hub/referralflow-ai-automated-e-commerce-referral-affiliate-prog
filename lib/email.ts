...
const FROM = process.env.EMAIL_FROM || 'ReferralFlow AI - Automated e-commerce referral & affiliate program management <noreply@example.com>';
const APP_NAME = 'ReferralFlow AI - Automated e-commerce referral & affiliate program management';
