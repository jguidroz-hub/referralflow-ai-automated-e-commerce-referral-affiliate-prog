  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="ReferralFlow AI - Automated e-commerce referral & affiliate program management-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
