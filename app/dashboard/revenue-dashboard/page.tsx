...
export default function FeaturePage() {
  const items = [
    { t: "MRR: $4,230", d: "↑ 12% vs last month • 89 active subscriptions • Churn: 3.2%", s: "growing" },
    { t: "Todays Sales: $342", d: "7 orders • AOV: $48.86 • Conversion rate: 2.8%", s: "active" },
    { t: "Top Product: Pro Plan", d: "$2,890 MRR • 58 subscribers • LTV: $680", s: "top" },
    { t: "Expansion Revenue: $450", d: "12 upgrades this month • Expansion rate: 8%", s: "growing" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Revenue Dashboard</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Track revenue metrics and growth</p>
